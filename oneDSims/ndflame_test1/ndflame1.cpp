...
int main(int argc, char** argv) {
  ...
  try {
    ...
    */
    ...
    double mdot_f = 0.24;
    string comp_o_str =  ;
    compositionMap comp_o_map;
    parseCompString("O2:0.21, N2:0.78, AR:0.01",  comp_o_map);
    
    compositionMap comp_f_map;
    parseCompString("C2H6:1",  comp_f_map);
    ...
    */
    ...
    ThermoPhase *ggg = newPhase("gri30.xml", "gri30_mix");
    IdealGasPhase *gas = dynamic_cast<IdealGasPhase *>(ggg);
    ...
    Sim1D * stagFlame = new Sim1D();

    stagFlame->solve(logLevel, refine_grid);
