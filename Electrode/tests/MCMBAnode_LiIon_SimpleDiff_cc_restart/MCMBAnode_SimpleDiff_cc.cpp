...
//    electrodeA->fixCapacityBalances_final();
    ...
    // Get the initial coulombs discharged -> this is saved in the restart file.
    double coul = electrodeA->capacityDischarged();
