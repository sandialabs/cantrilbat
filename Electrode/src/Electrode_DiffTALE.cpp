...
void Electrode_DiffTALE::calcSrcTermsOnCompletedStep()
{
    ...
    if (doPolarizationAnalysis_) {
        ...
        if (fabs (electProdAccounted - electProdTotal) > 1.0E-15) {
            throw Electrode_Error("Electrode_DiffTALE::calcSrcTermsOnCompletedStep()", "Error in accounting for electrons");
        }
 ...
 *
 */
int Electrode_DiffTALE::calcResid(double* const resid, const ResidEval_Type evalType)
{
 ...
 *  **********************************DEAD  BRANCH *****************************************************************
 */
int Electrode_DiffTALE::calcResid_2(double* const resid, const ResidEval_Type evalType)
{
    size_t iCell, iPh, jPh, jCell;
    double I_j;
    double I_jp1;
