...
#ifndef REACTINGSURDOMAINOLD_H
#define REACTINGSURDOMAINOLD_H
...
//==================================================================================================================================
//!  ReactingSurDomainOld is a class of reaction that combines the PhaseList information with the Zuzax ElectrodeKinetics class
/*!
 ...
 *            object
 */
class ReactingSurDomainOld : public ZZCantera::ElectrodeKinetics
{
public:

    //! Default constructor
    ReactingSurDomainOld();
     ...
     */
    ReactingSurDomainOld(ZZCantera::PhaseList* pl, size_t iskin);
     ...
     */
    ReactingSurDomainOld(const ReactingSurDomainOld& right);
     ...
     */
    ReactingSurDomainOld& operator=(const ReactingSurDomainOld& right);

    //! Default destructor
    virtual ~ReactingSurDomainOld();
    ...
    /*!
     *   This routine initializes a ReactingSurDomainOld object and its underlying interfacial kinetics
...
public:
     ...
     *  @param[in]           rsd                 Reference to the ReactingSurDomainOld whose values will be printed
     *
     *  @return                                  Returns a reference to the input ostream, as required for chaining 
     *                                           these commands together.
     */
    friend std::ostream& operator<<(std::ostream& s, ReactingSurDomainOld& rsd);
...
protected:
     ...
     *  current ReactingSurDomainOld object
     *
     ...
     *  current ReactingSurDomainOld kinetics object
     *
