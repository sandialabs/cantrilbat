...
{
//====================================================================================================================
ReactingSurDomainOld::ReactingSurDomainOld() :
    ElectrodeKinetics(),
    m_iphGlobKin(npos),
...
//====================================================================================================================
ReactingSurDomainOld::ReactingSurDomainOld(const ReactingSurDomainOld& right) :
    ElectrodeKinetics(),
    m_iphGlobKin(npos),
    m_DoSurfKinetics(false),
    m_pl(nullptr),
...
//==================================================================================================================================
ReactingSurDomainOld::ReactingSurDomainOld(ZZCantera::PhaseList* pl, size_t iskin) :
    ElectrodeKinetics(),
    ...
    deltaH_species_(0.0)
{
    ...
    if (!ok) {
	throw Electrode_Error("ReactingSurDomainOld::ReactingSurDomainOld()", "import from Phase list failed");
    }
}
//==================================================================================================================================
ReactingSurDomainOld& ReactingSurDomainOld::operator=(const ReactingSurDomainOld& right)
{
    /*
...
//==================================================================================================================================
/*
 * Destructor for the ReactingSurDomainOld object.
 *
...
// Kinetics
/*
 *  This virtual routine can be used to duplicate %ReactingSurDomainOld objects
 ...
 */
Kinetics* ReactingSurDomainOld::duplMyselfAsKinetics(const std::vector<thermo_t*>& tpVector) const
{
    ReactingSurDomainOld* rsd = new ReactingSurDomainOld(*this);
    rsd->assignShallowPointers(tpVector);
    return dynamic_cast<Kinetics*>(rsd);
}
//==================================================================================================================================
size_t ReactingSurDomainOld::globalPhaseIndex_fromKP(size_t iphKin) const
{
    return KinToPL_PhaseIndex_[iphKin];
}
//==================================================================================================================================
size_t ReactingSurDomainOld::kineticsPhaseIndex_fromPLP(size_t iphGlob) const
{
    // This sometimes returns npos, which is the correct response
    return PLToKin_PhaseIndex_[iphGlob];
}
//==================================================================================================================================
size_t ReactingSurDomainOld::globalSpeciesStart_fromKP(size_t iphKin) const
{
    return KinToPL_SpeciesStartIndex_[iphKin];
}
//==================================================================================================================================
size_t ReactingSurDomainOld::kineticsSpeciesStart_fromPLP(size_t iphGlob) const
{
    // This sometimes returns npos, which is the correct response
    return PLToKin_SpeciesStartIndex_[iphGlob];
}
//==================================================================================================================================
size_t ReactingSurDomainOld::kineticsSpeciesIndex_fromPLSpeciesIndex(size_t kGlob) const
{
    // This sometimes returns npos, which is the correct response
    return PLToKin_SpeciesIndex_[kGlob];
}
//==================================================================================================================================
size_t ReactingSurDomainOld::globSpeciesIndex_fromKinSpeciesIndex(size_t kKin) const
{
    // This sometimes returns npos, which is the correct response
...
//==================================================================================================================================
void ReactingSurDomainOld::limitROP(const doublevalue* const nMoles)
{
...
//==================================================================================================================================
const std::vector<doublevalue>& ReactingSurDomainOld::calcNetLimitedSurfaceProductionRateDensities(const doublevalue* const n)
{
    updateROP();
    limitROP(n);
...
//==================================================================================================================================
const std::vector<double>& ReactingSurDomainOld::calcNetSurfaceROP()
{
    updateROP();
    return m_ropnet;
}
//==================================================================================================================================
const std::vector<double>& ReactingSurDomainOld::calcSurfaceCreationRateDensities()
{
    getCreationRates(speciesCreationRates_.data());
    return speciesCreationRates_;
}
//==================================================================================================================================
const std::vector<double>& ReactingSurDomainOld::calcSurfaceDestructionRateDensities()
{
...
double ReactingSurDomainOld::getCurrentDensityRxn(double* const currentDensityRxn) 
{
...
//==================================================================================================================================
double ReactingSurDomainOld::getLimitedCurrentDensityRxn(const doublevalue* const nMoles)
{
 ...
 */
std::ostream& operator<<(std::ostream& s, ReactingSurDomainOld& rsd)
{
    ThermoPhase* th;
...
//==================================================================================================================================
void ReactingSurDomainOld::init()
{
...
//==================================================================================================================================
void ReactingSurDomainOld::finalize()
{
...
//==================================================================================================================================
bool ReactingSurDomainOld::importFromPL(ZZCantera::PhaseList* const pl, size_t iskin)
{
    try {
        //
        ...
        if (iskin == npos || iskin >= pl->nSurPhases()) {
           throw Electrode_Error("ReactingSurDomainOld::importFromPL()", "index of surface reaction, %d, not within bounds", 
                                 (int) iskin);
        }
        ...
        if (!ok) {
            throw ZuzaxError("ReactingSurDomainOld::importFromPL()", "importKinetics() returned an error");
        }
        ...
        showErrors(std::cout);
        throw ZuzaxError("ReactingSurDomainOld::importFromPL()", "error encountered");
        return false;
    } catch (ZuzaxError) {
        showErrors(std::cout);
        throw ZuzaxError("ReactingSurDomainOld::importFromPL()", "error encountered");
...
//==================================================================================================================================
void ReactingSurDomainOld::reassignPhaseList(PhaseList* pl_ptr)
{
    m_pl = pl_ptr;
}
//==================================================================================================================================
void ReactingSurDomainOld::reinitializeIndexing()
{
    if (!m_pl) {
         throw ZuzaxError("ReactingSurDomainOld::reinitializeIndexing()",
    ...
    for (size_t kph = 0; kph < nKinPhases; ++kph) {
        ...
        if (jphPL == npos) {
            throw ZuzaxError("ReactingSurDomainOld::reinitialeIndexing()", "phase not found");
        }
        ...
        for (size_t k = 0; k < nspPhase; ++k) {
            if (PLToKin_SpeciesIndex_[kstartPL + k] != npos) {
                throw ZuzaxError("ReactingSurDomainOld::importFromPL()",
...
void ReactingSurDomainOld::addOCVoverride(OCV_Override_input *ocv_ptr)
{
    //
    ...
    AssertThrow(kspec != npos, "ReactingSurDomainOld::addOCVoverride(): MF_DoD_LocalSpeciesID is not set");
    //
...
//====================================================================================================================
RSD_OCVmodel* ReactingSurDomainOld::OCVmodel()
{
    return OCVmodel_;
}
//====================================================================================================================
void ReactingSurDomainOld::deriveEffectiveChemPot()
{
    /*
...
//==================================================================================================================================
void ReactingSurDomainOld::deriveEffectiveThermo()
{
    /*
     *   Find and store the temperature
     */
...
//==================================================================================================================================
void ReactingSurDomainOld::updateMu0()
{
    /*
...
//         ( works for MCMB )
void ReactingSurDomainOld::getDeltaGibbs(doublevalue* const deltaG)
{
    /*
...
//==================================================================================================================================
void ReactingSurDomainOld::getDeltaGibbs_Before(doublevalue* const deltaG)
{
    for (size_t n = 0; n < nPhases(); ++n) {
...
// Modification for OCV override when called for.
//         ( works for MCMB )
void ReactingSurDomainOld::getDeltaElectrochemPotentials(doublevalue* const deltaM)
{
     /*
      * Get the chemical potentials of the species in the all of the phases used in the 
      * kinetics mechanism -> We store them in the vector m_mu[]. which later can get modified for OCV override
...
//==================================================================================================================================
// Modification for OCV override when called for.
void ReactingSurDomainOld::getDeltaEnthalpy(doublevalue* const deltaH)
{
    /*
...
//=======================================================================================================================
// Modification for OCV override when called for.
void ReactingSurDomainOld::getDeltaEnthalpy_Before(doublevalue* const deltaH)
{
    for (size_t n = 0; n < nPhases(); n++) {
...
//=======================================================================================================================
// Modification for OCV override when called for
void ReactingSurDomainOld::getDeltaEntropy(doublevalue* const deltaS)
{
    /*
...
//==================================================================================================================================
// Modification for OCV override when called for
void ReactingSurDomainOld::getDeltaEntropy_Before(doublevalue* const deltaS)
{
    for (size_t n = 0; n < nPhases(); n++) {
 ...
 */
void ReactingSurDomainOld::getDeltaGibbs_electrolyteSS(doublevalue* const deltaG_special)
{
     /*
...
//==================================================================================================================================
// Modification for OCV override when called for
void ReactingSurDomainOld::getDeltaSSEnthalpy(doublevalue* const deltaH)
{
   /*
...
//==================================================================================================================================
// Modification for OCV override when called for
void ReactingSurDomainOld::getDeltaSSGibbs(doublevalue* const deltaGSS)
{
    /*
...
//==================================================================================================================================
void ReactingSurDomainOld::getDeltaSSEntropy(doublevalue* const deltaS)
{
    /*
     *  Get the standard state entropy of the species.
...
//==================================================================================================================================
void ReactingSurDomainOld::getOCVThermoOffsets_ReplacedSpecies(double& deltaG_species, double& deltaH_species, double& deltaS_species)
{
    deltaG_species = 0.0;
    deltaH_species = 0.0;
    deltaS_species = 0.0;
