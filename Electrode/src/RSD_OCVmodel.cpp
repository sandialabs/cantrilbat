...
double RSD_OCVmodel::OCV_value() const
{
    ...
    if (modelID_ == 101) {
       ...
       volts = (  0.124   + 1.5 * exp(-150.0 * relExtent_) 
                   + 0.0351 * tanh( (relExtent_ - 0.286) / 0.083)
                   - 0.0045 * tanh( (relExtent_ - 0.90)  / 0.119)
                   - 0.035  * tanh( (relExtent_ - 0.99)  / 0.05 )
                   - 0.0147 * tanh( (relExtent_ - 0.50)  / 0.034)
                   - 0.102  * tanh( (relExtent_ - 0.194) / 0.142)
