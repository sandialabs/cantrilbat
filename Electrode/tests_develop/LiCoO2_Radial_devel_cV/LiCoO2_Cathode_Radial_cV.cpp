/*
 * $Id: LiCoO2_Cathode_1.cpp 202 2013-01-09 00:10:07Z hkmoffa $
 */
/*
...
int main(int argc, char **argv)
{
  ...
  try {
     ...
     */
    Cantera::Electrode_RadialDiffRegions *electrodeC  = new Cantera::Electrode_RadialDiffRegions();
    ...
    electrodeC->setVoltages(1.2, 0.0);

    //double oc = electrodeC->openCircuitVoltageSS(0);
    double oc = electrodeC->openCircuitVoltage(0);
    printf("oc[0] = %g\n", oc);
