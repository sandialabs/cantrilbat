 ...
 */
class BE_StrDbl : public BlockEntry
{
public:
     ...
     */
    BE_StrDbl(const BE_StrDbl& right);
     ...
     */
    BE_StrDbl& operator=(const BE_StrDbl& right);
     ...
     *
     *    @return       Returns a pointer to a vector of doubles of length, listlength,
     *                  which represents the status of the internal vector
     */
     ...
     *
     *  @return         Returns a pointer to current vector of doubles of length, listlength,
