...
public:
     ...
     */
    LE_OneBoolInt(const char* keyName, int* addrVal, int numRL = 0, const char* varName = 0);

    //! Copy constructor
    /*!
     *    @param[in]        right                 Object to be copied
     */
    LE_OneBoolInt(const LE_OneBoolInt& right);
     ...
     */
    LE_OneBoolInt& operator=(const LE_OneBoolInt& right);
