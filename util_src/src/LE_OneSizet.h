 ...
 *  \link BEInput::LE_OneSizet LE_OneSizet\endlink).
 */
 ...
 *      int reqd = 1;
 *      LE_OneSizet *i2 = new LE_OneSizet("Number of Iterations",
 *                                     &gI.numIts,
 *                                     reqd, "numIts");
 *      i2->set_default(50);
 ...
 *  #CurrValue of the %LE_OneSizet object.
 *
 * @ingroup blockentryModule
 */
class LE_OneSizet : public LineEntry
{
public:
     ...
     * @param addrVal   Address of the size_t, external to the
     ...
     */
    LE_OneSizet(const char* keyName, size_t* addrVal, int numRL = 0, const char* varName = 0);

    //! Copy constructor
    /*!
     * @param right Object to be copied
     */
    LE_OneSizet(const LE_OneSizet& right);
     ...
     */
    LE_OneSizet& operator=(const LE_OneSizet& right);
    ...
    //! Return the current value as a size_t
    /*!
     * This is a nonvirtual function since the return type is specific to this child.
     *
     * @return                  Returns the current value as a size_t
     */
    size_t currentTypedValue() const;
    ...
    /*!
     * @param[in]            defValue            size_t value that will be the default.
     */
    void set_default(size_t defValue);
     ...
     */
    void set_limits(size_t maxValue, size_t minValue);
...
private:
    ...
    //! The address of the size_t that gets updated by the processing of the %LineEntry
    /*!
