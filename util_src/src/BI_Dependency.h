...
public:
     ...
     *  @param       b           object to be copied
     *
     *   @return                 Returns a reference of the current object
     */
     ...
     * been satisfied.
     *
     * @return              returns a boolean indicating whether the dependency has been satisfied.
     */
    ...
    /*!
     * @return                      Returns the ResultType  which is of type BIDRT_TYPE
     */
    BIDRT_TYPE ResultType() const;

    //! Returns the ServiceRequestType of this dependency
    /*!
     *  @return                      Returns the  ServiceRequestType which is of type BIDSR_TYPE
     */
    BIDSR_TYPE ServiceRequestType() const;

    //! Returns a const pointer to the source BaseEntry
    /*!
     *   @return                     Returns a pointer to the source BaseEntry object
     */
