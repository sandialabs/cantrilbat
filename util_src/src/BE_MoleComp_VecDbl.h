...
#ifndef BE_MOLECOMP_VECDBL_H
#define BE_MOLECOMP_VECDBL_H
 ...
 */
class BE_MoleComp_VecDbl : public BE_StrVecDbl
{
public:
     ...
     */
    BE_MoleComp_VecDbl(const char* blockName,
     ...
     */
    BE_MoleComp_VecDbl(const BE_MoleComp_VecDbl& right);
     ...
     */
    BE_MoleComp_VecDbl& operator=(const BE_MoleComp_VecDbl& right);
