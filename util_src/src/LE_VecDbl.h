 ...
 *      int reqd = 3;
 *      LE_VecDbl *v1 = new LE_VecDbl("Molar Volumes",
 *                                  &(gI.molarVolumes),
 *                                    gI.numSpecies, reqd,
 *                                    "molarVolumes");
 ...
 *
 *   LineEntry *le = besmd->searchLineEntry("Molar Volumes");
 *   LE_VecDbl *le_dbl = dynamic_cast<LE_VecDbl *>(le);
 ...
 */
class LE_VecDbl : public LineEntry
{
public:
     ...
     */
    LE_VecDbl(const char* keyName, double** addrVal, int vecLength,
     ...
     */
    LE_VecDbl(const LE_VecDbl& right);
     ...
     */
    LE_VecDbl& operator=(const LE_VecDbl& right);
     ...
     *
     * @param lineArgTok  Pointer to the token containing the arguments to the lineEntry. This is
     ...
     *
     *   @return                      Returns a const pointer to the current last value entered
     */
