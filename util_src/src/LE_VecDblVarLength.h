...
public:
     ...
     */
    LE_VecDblVarLength(const char* keyName, double** hndVec, int vecLength, int numRL = 0, const char* varName = 0);
     ...
     *
     *  @return                    Returns a pointer to a duplicate of the current object
     */
     ...
     *
     *  @return    Returns a pointer to the vector of supplied doubles.
     */
    ...
    //! Check for requirements being met at the end of input. This involves checking for whether the number of times
    //! processed is equal to the number of times required.
    /*!
     * @param     throwSpecificError             Usually false.
     *
     * @return                                   Returns whether the requirement for this card are met at the end of processing  
     */
