 ...
 *  input deck. This is needed for constitutive modeling
 *  packages, typically. 
 *
 ...
 *
 *
 *  Dependencies amongst the cards are also handled.
 *  This allows for a fairly tight error checking on the
 *  setup of problems. We require a conversation between
 *  the user and the program to occur.
 *
