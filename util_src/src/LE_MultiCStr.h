...
public:
     ...
     *  
     *      @return          This returns a const null-terminated Cstring  of the value. Note, the member is presumed to be owned
     *                       by this object, and therefore not subject to freeing.
     */
