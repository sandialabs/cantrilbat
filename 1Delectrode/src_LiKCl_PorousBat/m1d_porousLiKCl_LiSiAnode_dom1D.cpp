...
//=====================================================================================================================
  porousLiKCl_LiSiAnode_dom1D::porousLiKCl_LiSiAnode_dom1D(BDT_porAnode_LiKCl* bdd_pms_ptr) :
    porousElectrode_dom1D(bdd_pms_ptr),
    BDT_porAnode_LiKCl_ptr_(bdd_pms_ptr),
    nph_(0),
    nsp_(0),
...
porousLiKCl_LiSiAnode_dom1D::porousLiKCl_LiSiAnode_dom1D(const porousLiKCl_LiSiAnode_dom1D &r) :
    porousElectrode_dom1D((BDT_porAnode_LiKCl*)  r.BDT_porAnode_LiKCl_ptr_), 
...
//=====================================================================================================================
void
porousLiKCl_LiSiAnode_dom1D::SetupThermoShop1(const NodalVars* const nv, const double* const solnElectrolyte_Curr)
{
...
//=====================================================================================================================
   ...
   */
void
porousLiKCl_LiSiAnode_dom1D::SetupThermoShop2(const NodalVars* const nvL, const double* const solnElectrolyte_CurrL,
                                              ...
                                              int type)
{
  ...
  updateElectrolyteOld(&solnTemp[0], 0);
  updateElectrode();
}
  //=====================================================================================================================
   ...
   */
  void
  porousLiKCl_LiSiAnode_dom1D::updateElectrolyteOld(const double* const solnElectrolyte_Curr,
						 const double* const solnDotElectrolyte_Curr)
  {
     ...
     */
    getMFElectrolyte_solnOld(solnElectrolyte_Curr, solnDotElectrolyte_Curr);
    /*
 ...
 */
void
porousLiKCl_LiSiAnode_dom1D::updateElectrolyte(const NodalVars* const nv, const double* const solnElectrolyte_Curr)
{
    /*
     * Get the temperature: Check to see if the temperature is in the solution vector.
     *   If it is not, then use the reference temperature
 ...
 */
void
porousLiKCl_LiSiAnode_dom1D::getVoltages(const NodalVars* const nv, const double* const solnElectrolyte_Curr)
{
...
//=====================================================================================================================
void
porousLiKCl_LiSiAnode_dom1D::getMFElectrolyte_soln(const NodalVars* const nv, const double* const solnElectrolyte_Curr)
{
...
//=====================================================================================================================
void
porousLiKCl_LiSiAnode_dom1D::getElectrolyte_SolnDot(const NodalVars* const nv,
			        		      const double * const solnDotElectrolyte_Curr)
{
    size_t indexMF = nv->indexBulkDomainVar0(MoleFraction_Species);
    if (solnDotElectrolyte_Curr) {
						  ...
						  const double t )
{
  ...
  if (doWrite) {
	...
	if (iph == metalPhase || iph == solnPhase) {
	  ...
	  int nspPhase = tp->nSpecies();
	  int kStart = ee->globalSpeciesIndex(iph, 0);
	  for (int k = 0; k < nspPhase; k++) {
						  ...
						  const double t, const double delta_t, const double t_old)
{
	...
	//                    phiElectrolyte_Curr_
        ...
        if (solnDot_ptr) {
            ...
            updateElectrolyteOld(solnCentStart, &(solnDot[indexCent_EqnStart_BD]));
        } else {
            updateElectrolyteOld(solnCentStart, 0);
        }
	//
	//                    phiElectrode_Curr_
	//
        getVoltagesOld(solnCentStart);
	//
...
porousLiKCl_LiSiAnode_dom1D::getCapacity( double *initialCap, double *dischargedCap ) 
{
  depthOfDischarge_Electrode_ = 0.0;
  capacityZeroDoD_Electrode_  = 0.0;
  for (int iGbNode = BDD_ptr_->FirstGbNode; iGbNode <= BDD_ptr_->LastGbNode; iGbNode++) {
    int iCell = iGbNode - BDD_ptr_->FirstGbNode;
    depthOfDischarge_Electrode_ += depthOfDischargePA_Cell_[iCell];
    capacityZeroDoD_Electrode_ += capacityPA_Cell_[iCell];	
  }
