...
porousLiIon_Anode_dom1D::domain_prep(LocalNodeIndices* li_ptr)
{
    ...
    Zuzax::Electrode* ee = BDD_anode_ptr_->Electrode_;
 ...
 */
void
porousLiIon_Anode_dom1D::saveDomain(Zuzax::XML_Node& oNode,
...
//     
void
porousLiIon_Anode_dom1D::readDomain(const Zuzax::XML_Node& SimulationNode,
