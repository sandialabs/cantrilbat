...
porousLiIon_Anode_dom1D::instantiateElectrodeCells() 
{
  ...
  for (int iCell = 0; iCell < NumLcCells; iCell++) {
    ...
    indexCent_EqnStart_BD = LI_ptr_->IndexLcEqns_LcNode[index_CentLcNode] + nodeCent->OffsetIndex_BulkDomainEqnStart_BDN[0];
    ...
    if (PSinput.anode_input_->electrodeGrossArea > 0.0) {
      ...
      electrodeGrossArea = Pi * 0.25 * PSinput.anode_input_->electrodeGrossDiameter * PSinput.anode_input_->electrodeGrossDiameter;
    }
