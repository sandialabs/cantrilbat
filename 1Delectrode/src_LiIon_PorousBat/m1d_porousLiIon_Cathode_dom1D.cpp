				     ...
				     const Solve_Type_Enum solveType)
{
  ...
  for (int iCell = 0; iCell < NumLcCells; iCell++) {
	...
	double tmp3 = solnMoleFluxInterface_Cell_[iCell] * rdelta_t;
	...
	res[indexCent_EqnStart_BD + EQ_Species_offset_BD + k] -=
	  electrodeSpeciesMoleDelta_Cell_[nSpeciesElectrode_ * iCell + indexStartEOelectrolyte + k] * rdelta_t / electrodeCrossSectionalArea_;
      }
    }
    ...
    if (doTimeDependentResid) {
      ...
      if (residType == Base_ShowSolution) {
	if (iCell == 7) {
	  printf(" Cell = %d, Totalflux_Li+_R = %- 14.7e, -Totalflux_Li+_L = %- 14.7e", iCell, fluxXright[iLip_], -fluxXleft[iLip_]);
...
//=====================================================================================================================
void
porousLiIon_Cathode_dom1D::SetupThermoShop1(const doublereal * const solnElectrolyte_Curr, int type)
{
  if (type == 0) {
...
//=====================================================================================================================
void
porousLiIon_Cathode_dom1D::SetupThermoShop2(const doublereal * const solnElectrolyte_CurrL,
                                                 ...
                                                 const double delta_t)
{
  ...
  for (int iCell = 0; iCell < NumLcCells; iCell++) {
    ...
    soln[indexCent_EqnStart_BD + iVar_Voltage_ED] = volt;
