...
struct TableHeader {
    ...
    {
        PoreRadii = mdpUtil::mdp_alloc_dbl_1(num, 0.0);
    }
    ~TableHeader()
    {
        mdpUtil::mdp_safe_free((void**) &PoreRadii);
    }
};
...
struct TableItems {
    ...
    {
        HeightBlooms = mdpUtil::mdp_alloc_dbl_1(num, 0.0);
    }
    ~TableItems()
    {
        mdpUtil::mdp_safe_free((void**) &HeightBlooms);
    }
};
//=====================================================================================================================
