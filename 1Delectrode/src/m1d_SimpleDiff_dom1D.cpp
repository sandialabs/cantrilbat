...
//==============================================================================
SimpleDiff_dom1D::~SimpleDiff_dom1D() {
}
//==============================================================================
SimpleDiff_dom1D &
 ...
 */
void
SimpleDiff_dom1D::domain_prep(LocalNodeIndices *li_ptr)
{
  /*
  ...
  for (int iCell = 0; iCell < NumLcCells; iCell++) {
    ...
    if (doLeftFluxCalc) {
      if (nodeLeft == 0) {
         ...
         */
        fluxL = -DiffCoeff * surfArea * (Ccent - Cleft) / (xdel);
      }
    } else {
      /*
    ...
    if (nodeRight == 0) {
       ...
       */
      fluxR = -DiffCoeff * surfArea * (Cright - Ccent) / (xdel);
 ...
 */
void
SimpleDiff_dom1D::saveDomain(ZZCantera::XML_Node& oNode,
...
//=================================================================================
void
SimpleDiff_dom1D::err(const char *msg)
{
  printf("SimpleDiff_dom1D: function not implemented: %s\n", msg);
  exit(-1);
}
//=================================================================================
//=================================================================================
