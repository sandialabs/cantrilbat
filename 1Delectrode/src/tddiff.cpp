...
//==================================================================================================================================
//! Pointer to the Global ProblemResidEval object
m1d::ProblemResidEval* PS_ptr = 0;

//==================================================================================================================================
//! Allocation of storage for the Global ProblemStatement object
m1d::ProblemStatement PSinput;

//==================================================================================================================================
//!  Generate the Domain Objects
/*!
 *  @param[in]               ps                  Pointer to the problem residual object
 */
void
...
void printUsage()
{
    std::cout << "usage: mpequil [-h] [-help_cmdfile] [-d #] [mpequil.inp]" << std::endl;
    std::cout << "    -h           help" << std::endl;
    std::cout << "    -d           #   : level of debug printing" << std::endl;
    std::cout << "  mpequil.inp    : command file" << std::endl;
    std::cout << "                     : (if missing, assume mpequil.inp)" << std::endl;
    std::cout << std::endl;
}
//==================================================================================================================================
//!  main routine
 ...
 *  @param[in]               argv                pointer to a vector of arguments
...
main(int argc, char** argv)
{
    ...
    try {
        ...
        m1d::ProblemResidEval* ps = new m1d::ProblemResidEval(1.0E-13);
        PS_ptr = ps;
        ...
        m1d::EpetraJac* jac = new m1d::EpetraJac(*ps);
        jac->allocateMatrix();
        ...
        m1d::print0_epMultiVector(*res, "Residual Value");
         ...
         */
        m1d::Epetra_Vector_Ghosted& solnBE    = t1.solnVector();
        m1d::Epetra_Vector_Ghosted& solnDotBE = t1.solnDotVector();
        ...
        const m1d::Epetra_Vector_Owned& abstol = ps->atolVector();
     ...
     */
        ...
        std::cerr << "main:: Caught Trilinos integer error: " << eNum << "\n\n" << std::endl;
