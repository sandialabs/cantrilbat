...
BulkDomainDescription::BulkDomainDescription(const BulkDomainDescription& r) :
    DomainDescription(DL_ptr_),
    IDBulkDomain(r.IDBulkDomain)
{
    *this = r;
}
//==================================================================================================================================
BulkDomainDescription& BulkDomainDescription::operator=(const BulkDomainDescription& r)
{
    if (this == &r) {
        return *this;
    }
...
BulkDomainDescription::SetEquationDescription()
{
    ...
    for (int iEqn = 0; iEqn < NumEquationsPerNode; iEqn++) {
        ...
        if (eqnT.EquationType == Momentum_Axial) {
             ...
             */
            EquationIndexStart_EqName[iSpeciesConservationTPos] = std::min(iEqn,
                                                                           EquationIndexStart_EqName[iSpeciesConservationTPos]);
