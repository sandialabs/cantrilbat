...
static int statprocID = 0;

//! indicator of whether we are in print0syncBlock
static bool statInPrint0SyncBlock = false;
...
//==================================================================================================================================
void stream0::print0(const char* const format, ...)
{
    va_list ap;
...
//==================================================================================================================================
int stream0::fprintf0only(const char* const format, ...)
{
    int n = 0;
    if (statprocID == 0) {
        va_list ap;
...
//==================================================================================================================================
int sprint0(const char* const ibuf, FILE* const ff)
{
    int iSent = 0;
...
//==================================================================================================================================
void print0_epIntVector(const Epetra_IntVector& v, const char* const label, FILE* const of)
{
    stream0 os(of);
    const Epetra_Comm& cc = v.Comm();
    int mypid = cc.MyPID();
...
//==================================================================================================================================
void print0_epBlockMap(const Epetra_BlockMap& map, const char* const label, FILE* const of)
{
    stream0 os(of);
...
//==================================================================================================================================
void print0_epVbrMatrix(const Epetra_VbrMatrix& mat, const char* const label, FILE* const of)
{
    stream0 os(of);
...
void Print0_epVbrMatrix(stream0& os, const Epetra_VbrMatrix& mat)
{
    ...
    os << mat.NumMyBlockDiagonals() << endl;
