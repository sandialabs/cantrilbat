...
ProblemStatement::setup_input_pass1(BlockEntry* cf)
{
    ...
    LE_PickList* cpl = new LE_PickList("Coordinate System", (int*) &(coordinateSystemType_), ccpl, 2, 0,
...
ProblemStatement::setup_input_pass3(BlockEntry* cf)
{
     ...
     *
     */
    LE_OneStr* s1 = new LE_OneStr("Title", &(Title_), 100000, 1, 0, "Title");
    cf->addLineEntry(s1);
     ...
     */
    reqd = 1;
    LE_OneInt* i2 = new LE_OneInt("Problem Type", &(prob_type_), reqd, "prob_type");
    i2->set_default(0);
     ...
     */
    reqd = 0;
    LE_OneDbl* daud = new LE_OneDbl("Time Step for Algebraic Unknown Discontinuities", &(TimeStep_AUD_), reqd,
                                    "TimeStep_AUD_");
