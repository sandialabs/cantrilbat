...
namespace m1d
{
  ...
  public:
    ...
    SolnLayout(Zuzax::XML_Node *xmlSim);
    ...
    void readXML(Zuzax::XML_Node *simXML_ptr);

    SolnDomainBulk* readBulkDomainXML(Zuzax::XML_Node & domXML);

    SolnDomainSurf* readSurfDomainXML(Zuzax::XML_Node & domXML);
