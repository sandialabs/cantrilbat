...
/*
 *  $Id: LiKCl_infPlateBat.cpp 506 2013-01-07 22:43:59Z hkmoffa $
 */
  ...
  try {
    ...
    if (argc > 1) {
      ...
      for (int j = 1; j < argc; j++) {
        ...
        } else if (commandFile == "" || commandFile == "LiKCl_infPlateBat.inp") {
          //commandFile = tok;
        } else {
          printUsage();
          exit(1);
    ...
    boundaryMap["FlatAnode"] = 0;
    boundaryMap["FlatCathode"] = 1;
     ...
     */
    DomainLayout *dl = new DomainLayout_LiKCl_infPlateBat(&PSinput);
