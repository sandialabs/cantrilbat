 ...
 */
/*
 *    $Id: m1d_SurDomain_FlatLiSiAnode.h 363 2012-08-22 03:37:42Z hkmoffa $
 */

#ifndef M1D_SURDOMAIN_FLATLISIANODE_H_
#define M1D_SURDOMAIN_FLATLISIANODE_H_
 ...
 *
 */
class SurDomain_FlatLiSiAnode : public ReactingSurDomain
{
public:
  //! Constructor
  /*!
   ...
   */
  SurDomain_FlatLiSiAnode(m1d::SurfDomainDescription &sdd, int problemType);
   ...
   */
  SurDomain_FlatLiSiAnode(const SurDomain_FlatLiSiAnode &r);
   ...
   */
  SurDomain_FlatLiSiAnode &
  operator=(const SurDomain_FlatLiSiAnode&r);
...
protected:
   ...
   */
  ZZCantera::ThermoPhase *electrolyteThermo_;
