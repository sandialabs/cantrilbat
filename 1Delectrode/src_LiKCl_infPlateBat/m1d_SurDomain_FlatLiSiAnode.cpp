      ...
      electrodeSpeciesProdRates_(0), phaseMoleFlux_(0), surfaceArea_(1.0)
{
  ...
  ElectrodeA_ = fa->ElectrodeA_;

  // Determine electrolyteThermo_;
  //    We determine this from the solnPhase_ variable in ElectrodeA_
  //    Then we will use the pointer to ThermoPhase from within ElectrodeA_
  int iph = ElectrodeA_->solnPhaseIndex();
  electrolyteThermo_ = &(ElectrodeA_->thermo(iph));
...
//=====================================================================================================================
SurDomain_FlatLiSiAnode::SurDomain_FlatLiSiAnode(const SurDomain_FlatLiSiAnode &r) :
  ReactingSurDomain(r.SDD_), ElectrodeA_(0), electrolyteThermo_(0), bedd_(0), mfElectrolyte_Soln(0),
      mfElectrolyte_Thermo(0), phiElectrolyte_(0), phiAnode_(0), NumNodeEqns(0), SpecFlag_NE(0), Value_NE(0),
      electrodeSpeciesProdRates_(0), phaseMoleFlux_(0), surfaceArea_(1.0)
{
  operator=(r);
...
//=====================================================================================================================
// Destructor
SurDomain_FlatLiSiAnode::~SurDomain_FlatLiSiAnode()
{
}
//=====================================================================================================================
// Assignment operator
 ...
 */
SurDomain_FlatLiSiAnode &
SurDomain_FlatLiSiAnode::operator=(const SurDomain_FlatLiSiAnode &r)
{
  if (this == &r) {
    return *this;
  }
 ...
 */
void
SurDomain_FlatLiSiAnode::domain_prep(LocalNodeIndices *li_ptr)
{
  /*
 ...
 */
void
SurDomain_FlatLiSiAnode::residEval(Epetra_Vector &res,
				   ...
				   const Solve_Type_Enum solveType)
{
  ...
  // Cantera::ReactingSurDomain *rSurDomain = ElectrodeA_->m_rSurDomain;
   ...
   */
  res[index_EqnStart + EQ_TCont_offset_BD] -= solnMoleFlux * surfaceArea_ * area_cvb;
  ...
  // ------------------ SURFACE DOMAIN -----------------------------------
  /*
   *   Only surface equation for the anode has a Dirichlet condition applied on it.
   */
  /*
                                            ...
                                            const ResidEval_Type_Enum residType)
{
   ...
   */
  ElectrodeA_->setState_TP(Temp, pres);
  ElectrodeA_->setVoltages(phiAnode_, phiElectrolyte_);
  ElectrodeA_->setElectrolyteMoleNumbers(&(mfElectrolyte_Thermo[0]), false);
  /*
   ...
   */
  //ElectrodeA_->downloadMP();
  ElectrodeA_->updateState();

}
//=====================================================================================================================
void
SurDomain_FlatLiSiAnode::getVoltages(const double * const solnElectrolyte, const double * const solnSolid)
{
...
//=====================================================================================================================
void
SurDomain_FlatLiSiAnode::getMFElectrolyte_soln(const double * const solnBulk)
{
 ...
 */
void
SurDomain_FlatLiSiAnode::saveDomain(Cantera::XML_Node& oNode,
 ...
 */
void
SurDomain_FlatLiSiAnode::showSolution(const Epetra_Vector *soln_GlAll_ptr,
                                      const Epetra_Vector *solnDot_GlAll_ptr,
                                      const Epetra_Vector *soln_ptr,
                                      const Epetra_Vector *solnDot_ptr,
                                      const Epetra_Vector *solnOld_ptr,
...
void
SurDomain_FlatLiSiAnode::writeSolutionTecplotHeader()
{
  int locGbNode = SDD_.LocGbNode;
  int mypid = LI_ptr_->Comm_ptr_->MyPID();
 ...
 */
void
SurDomain_FlatLiSiAnode::writeSolutionTecplot(const Epetra_Vector *soln_GlAll_ptr,
						const Epetra_Vector *solnDot_GlAll_ptr,
						const double t )
{
  int locGbNode = SDD_.LocGbNode;
 ...
 */
void
SurDomain_FlatLiSiAnode::initialConditions(const bool doTimeDependentResid,
 ...
 */
void 
SurDomain_FlatLiSiAnode::setAtolVector(double atolDefault, const Epetra_Vector_Ghosted & soln, 
 ...
 */
void 
SurDomain_FlatLiSiAnode::setAtolVector_DAEInit(double atolDefault, const Epetra_Vector_Ghosted & soln, 
 ...
 */
void 
SurDomain_FlatLiSiAnode::setAtolDeltaDamping(double atolDefault,  double relcoeff, 
 ...
 */
void 
SurDomain_FlatLiSiAnode::setAtolDeltaDamping_DAEInit(double atolDefault,  double relcoeff, 
						     const Epetra_Vector_Ghosted & soln, 
						     const Epetra_Vector_Ghosted & solnDot,
						     Epetra_Vector_Ghosted & atolDeltaDamping,
						     const Epetra_Vector_Ghosted * const atolV)
