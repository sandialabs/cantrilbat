...
//=====================================================================================================================
//! Specification of boundary conditions attached to an electrode
/*!
 *    
 */
class SurDomain_Electrode : public SurBC_Dirichlet
{
public:
    //! Constructor
    /*!
     ...
     */
    SurDomain_Electrode(m1d::SurfDomainDescription& sdd, int problemType);
     ...
     */
    SurDomain_Electrode(const SurDomain_Electrode& r);

    //! Destructor
    virtual
    ~SurDomain_ElectrodeCollector();
     ...
     */
    SurDomain_Electrode&
    operator=(const SurDomain_Electrode r);
