...
/*
 * $Id: FuncElectrodeCurrent.cpp 504 2013-01-07 22:32:48Z hkmoffa $
 */
/*
...
#define WRITE_IV_ITER
   ...
   *
   */
  CurrentFunc::CurrentFunc(m1d::SolNonlinear_CurrentSolve * solverC,
			   m1d::SolNonlinear * solverV,
			   m1d::ProblemResidEval *func,
			   m1d::Epetra_Vector_Ghosted *y_comm,
			   m1d::Epetra_Vector_Ghosted *ydot_comm,
			   double CJ,
			   double time_curr,
			   double deltaT) :
