/**
 *  @file  m1d_ProblemStatementCell.cpp Definitions for an expanded ProblemStatement object for batteries
 */
/*
 ...
 */
ProblemStatementCell* PSCinput_ptr = nullptr;
...
ProblemStatementCell::ProblemStatementCell() :
    ...
    fromDakotaFileName_("params.in"), 
    toDakotaFileName_("results.out"),
    nTotPhases_(0), 
    nTotSpecies_(0), 
    nTotElements_(0),
...
ProblemStatementCell::setup_input_pass2(BlockEntry* cf)
{
     ...
     */
    reqd = 0;
    LE_OneDbl* dacoeff = new LE_OneDbl("Anode Heat Transfer Coefficient", &(anodeHeatTranCoeff_), reqd,
                                       "anodeHeatTranCoeff");
     ...
     */
    reqd = 0;
    LE_OneDbl* dccoeff = new LE_OneDbl("Cathode Heat Transfer Coefficient", &(cathodeHeatTranCoeff_), reqd,
                                       "cathodeHeatTranCoeff_");
...
ProblemStatementCell::setup_input_pass3(BlockEntry* cf)
{
    ...
    LE_OneDblUnits* d1 = new LE_OneDblUnits("Discharge Current", &(icurrDischargeSpecified_), 0, "icurrDischargeSpecified",
                                            ucCurr);
    d1->set_default(1.0);
    ...
    */
    ...
    reqd = 0;
    LE_OneDblUnits* d5 = new LE_OneDblUnits("Separator Thickness", &(separatorThickness_), reqd, "separatorThickness",
                                            ucL2);
     ...
     */
    reqd = 1;
    LE_OneDbl* dvf = new LE_OneDbl("Separator Solid Skeleton Volume Fraction", &(separatorSolid_vf_), reqd,
                                   "separatorSoild_vf");
    dvf->set_default(-1.0);
    cf->addLineEntry(dvf);
     ...
     */
    reqd = 0;
    LE_OneInt* iMAX_SG = new LE_OneInt("Maximum Number of Subcycle Steps per Global Steps",
                                       &maxSubgridTimeStepsPerGlobalTimeStep_,
